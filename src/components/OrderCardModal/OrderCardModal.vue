  ...
  <div class="container">
      ...
      <div class="data-input modal-content-block">
        <div class="text-input">
          ...
          />
          <label 
            class="label text-input__placeholder"
            v-on:click="labelClick"
          >ФИО</label>
        </div>

        <div class="checkmark text-input__checkmark" v-show="input.name.isValid"></div>
        <p
          class="error"
      ...
      <div class="data-input modal-content-block">
        ...
        <div class="checkmark text-input__checkmark" v-show="input.email.isValid"></div>
        <p
          class="error"
      ...
      <div class="data-input modal-content-block">
        ...
        <div class="checkmark text-input__checkmark" v-show="input.phone.isValid"></div>
        <p
          class="error"
      ...
      <div class="agree-toggler modal-content-block">
        <div class="checkbox-input">
          ...
          />
          <label 
            class="label checkbox-input__label"
            for="agree-checkbox">
